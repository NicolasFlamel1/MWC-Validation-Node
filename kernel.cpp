...
// Constructor
Kernel::Kernel(const Features features, const uint64_t fee, const uint64_t lockHeight, const uint64_t relativeHeight, const uint8_t excess[Crypto::COMMITMENT_LENGTH], const uint8_t signature[Crypto::SINGLE_SIGNER_SIGNATURE_LENGTH]) :

	// Delegate constructor
	Kernel(features, fee, lockHeight, relativeHeight, excess, signature, false)
{
}
